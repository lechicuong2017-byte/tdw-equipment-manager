...
type VehicleNavSection = "overview" | "fleet" | "inspections" | "insurance" | "repairs" | "fuel" | "tolls" | "settings" | "reports";
...
const items: { key: VehicleNavSection; label: string; icon: AppIconName; href: string }[] = [
  ...
  { key: "tolls", label: "VETC", icon: "toll", href: "/vehicles?section=tolls" },
