...
export default async function TelecomPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}) {
  ...
  return <div className="telecom-workspace">
    ...
    <nav className="telecom-nav" aria-label="Mục viễn thông"><Link href="/modules">← Đổi phân hệ</Link><Link href="/telecom/phones">Số điện thoại</Link><a href="#telecom-reports">Tổng hợp & báo cáo</a><a href="#telecom-invoices">Hóa đơn dịch vụ</a><Link href="/account">Tài khoản</Link></nav>
