...
Trong **Xem / Sửa**, ghi ngày đã thanh toán, ghi chú hoặc chỉnh hạng mục/nhóm. Để ngày trống tức chưa thanh toán. Xóa có xác nhận và là xóa mềm; nhật ký vẫn giữ dữ liệu cũ. Hóa đơn không bị chỉnh âm thầm số tiền khi nhập lại: nếu cùng danh tính nhưng khác tiền, kỳ cước hoặc thuê bao thì chặn để đối chiếu.
...
Migration: `202609070001_telecom_cost_management.sql`. Không thay đổi dữ liệu xe, VPP hay thiết bị.
