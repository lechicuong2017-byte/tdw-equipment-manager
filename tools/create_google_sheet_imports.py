...
SETTINGS_ROWS = [
    ...
    ["maintenance_type_KIEM_TRA_SUA_CHUA", "maintenance_type", "KIEM_TRA_SUA_CHUA", "Kiểm tra / sửa chữa", 1, "TRUE"],
    ["maintenance_type_BAO_DUONG_DINH_KY", "maintenance_type", "BAO_DUONG_DINH_KY", "Bảo dưỡng định kỳ", 2, "TRUE"],
    ["maintenance_type_VE_SINH_LAM_SACH", "maintenance_type", "VE_SINH_LAM_SACH", "Vệ sinh / làm sạch", 3, "TRUE"],
    ["maintenance_type_THAY_THE_LINH_KIEN", "maintenance_type", "THAY_THE_LINH_KIEN", "Thay thế linh kiện", 4, "TRUE"],
    ["maintenance_type_CAI_DAT_CAU_HINH", "maintenance_type", "CAI_DAT_CAU_HINH", "Cài đặt / cấu hình", 5, "TRUE"],
    ["maintenance_type_XU_LY_SU_CO", "maintenance_type", "XU_LY_SU_CO", "Xử lý sự cố", 6, "TRUE"],
