...
begin
  required_permission := case target_export_type
    ...
    when 'liquidations' then 'reports.assets.export'
    ...
    when 'vehicles' then 'reports.vehicles.export'
    when 'vehicle_inspections' then 'reports.vehicles.export'
    when 'vehicle_repairs' then 'reports.vehicles.export'
    when 'vehicle_fuel' then 'reports.vehicles.export'
    else null
  end;
